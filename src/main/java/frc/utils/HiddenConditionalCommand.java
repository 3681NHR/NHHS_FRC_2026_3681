 ...
 */
public class HiddenConditionalCommand extends Command {
  ...
  public HiddenConditionalCommand(Command onTrue, Command onFalse, BooleanSupplier condition) {
  ...
  public String getName(){
    return m_condition.getAsBoolean() ? m_onTrue.getName() : m_onFalse.getName();
  }
}
