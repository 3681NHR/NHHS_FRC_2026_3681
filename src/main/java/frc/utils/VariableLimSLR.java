...
public class VariableLimSLR {
   ...
   */
  public VariableLimSLR(double positiveRateLimit, double negativeRateLimit, double initialValue) {
   ...
   */
  public VariableLimSLR(double rateLimit) {
  ...
  public void setLim(double plim, double nlim){
