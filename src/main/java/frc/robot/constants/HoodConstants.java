...
public final class HoodConstants {
    ...
    public static final Angle HOOD_MAX_ANGLE = Degrees.of(47);
    
    public static final PIDGains.SimpleFF HOOD_ID_GAINS = new PIDGains.SimpleFF(0.3,35,0.0000001);//from sysid
    
    public static final PIDGains.ProfiledPID HOOD_PID_GAINS = new PIDGains.ProfiledPID(40, 0, 5, 0.2, 3).makeTunable("Tuning/Hood/PID");
    public static final PIDGains.SimpleFF HOOD_FF_GAINS = new PIDGains.SimpleFF(0.75,25,0.0).makeTunable("Tuning/Hood/FF");
