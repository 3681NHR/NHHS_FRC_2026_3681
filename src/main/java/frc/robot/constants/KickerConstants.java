...
public final class KickerConstants {
    ...
    public static final PIDGains.PID KICKER_PID_GAINS = new PIDGains.PID(1.0, 0, 0);
    public static final PIDGains.SimpleFF KICKER_FF_GAINS = new PIDGains.SimpleFF(1.0, 0, 0);
