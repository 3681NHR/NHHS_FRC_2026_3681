...
public final class KickerConstants {
    ...
    public static final LinearVelocity KICKER_FEED_VELOCITY = Centimeters.per(Seconds).of(6);

    public static final PIDGains.SimpleFF KICKER_ID_GAINS = new PIDGains.SimpleFF(0.0, 1, 0.001);

    public static final PIDGains.SimpleFF KICKER_FF_GAINS = new PIDGains.SimpleFF(0.0, 1, 0.0).makeTunable("Tuning/Kicker/FF");
