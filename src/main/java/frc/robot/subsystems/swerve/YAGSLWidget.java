...
//stole most of this from the YAGSL library
/**
 * posts swerve telemetry with formatting to trick elastic into using the YAGSL
 * widget, which has much more data
 */
public class YAGSLWidget {
    /**
     ...
     */
    private static final DoubleArrayPublisher measuredStatesArrayPublisher = NetworkTableInstance.getDefault()
            .getTable("SmartDashboard")
     ...
     */
    private static final DoubleArrayPublisher desiredStatesArrayPublisher = NetworkTableInstance.getDefault()
            .getTable("SmartDashboard")
     ...
     */
    private static final DoubleArrayPublisher measuredChassisSpeedsArrayPublisher = NetworkTableInstance.getDefault()
            .getTable("SmartDashboard")
     ...
     */
    private static final DoubleArrayPublisher desiredChassisSpeedsArrayPublisher = NetworkTableInstance.getDefault()
            .getTable("SmartDashboard")
     ...
     */
    private static final DoublePublisher maxAngularVelocityPublisher = NetworkTableInstance.getDefault()
            .getTable("SmartDashboard")
     ...
     */
    private static final StructArrayPublisher<SwerveModuleState> measuredStatesStruct = NetworkTableInstance
            .getDefault()
            .getTable("SmartDashboard")
     ...
     * Struct publisher for AdvantageScope swerve widgets.
     */
    private static final StructArrayPublisher<SwerveModuleState> desiredStatesStruct = NetworkTableInstance.getDefault()
            .getTable("SmartDashboard")
     ...
     */
    private static final StructPublisher<ChassisSpeeds> measuredChassisSpeedsStruct = NetworkTableInstance.getDefault()
            .getTable("SmartDashboard")
     ...
     */
    private static final StructPublisher<ChassisSpeeds> desiredChassisSpeedsStruct = NetworkTableInstance.getDefault()
            .getTable("SmartDashboard")
     ...
     */
    private static final StructPublisher<Rotation2d> robotRotationStruct = NetworkTableInstance.getDefault()
            .getTable("SmartDashboard")
    ...
    private static final StringPublisher forwardDirectionPublisher = NetworkTableInstance.getDefault()
            ...
            .publish();
    /**
     * Odometry cycle time, updated whenever {@link SwerveDrive#updateOdometry()} is
     * called.
     */
     ...
     * {@link swervelib.SwerveModule#setDesiredState(SwerveModuleState, boolean, double)}
     * is called for the last module.
     */
    ...
    /**
     * Start the odom cycle timer to calculate how long each odom took. Independent
     * of periodic loops.
     */
